...
public interface VoteService {
    Vote create(Vote vote, int userId, int restaurantId) throws InvalidDateTimeException;

    void update(Vote vote, int userId, int restaurantId) throws NotFoundException, InvalidDateTimeException;
