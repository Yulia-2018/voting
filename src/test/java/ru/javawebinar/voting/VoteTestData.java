...
public class VoteTestData {
    ...
    public static Vote createForCurrentDate(VoteService service) {
        Vote vote = new Vote(null, LocalDate.now(), RESTAURANT2);
        return service.create(vote, LocalTime.of(9, 45), USER_ID);
    }
